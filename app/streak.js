...
//     useEffect(() => {
//         (async () => {
//             const saved = await AsyncStorage.getItem("streak-level");
//             setLevel(saved ? parseInt(saved) : 1);
//         })();
//     }, []);

//     // ICONS from URL 
//     const ICON_BIG = "https://i.ibb.co/Xp60F7F/big-medal.png";
//     const ICON_SMALL = "https://i.ibb.co/bFywXKb/small-medal.png";
//     const ICON_LOCKED = "https://i.ibb.co/T0QZ0xJ/locked-medal.png";
...
//                 {/* BIG MEDAL ICON */}
//                 <Image
//                     source={{ uri: streakLevels[level - 1].bigIcon }}
...
//                                 <Image
//                                     source={{
//                                         uri: item.unlocked ? item.smallIcon : item.lockedIcon,
//                                     }}
